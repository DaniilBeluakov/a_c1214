...
while True:
    def converter():
        def counter(end):
            ...
            if end == 1:
                b = str(input(Fore.LIGHTMAGENTA_EX + 'Write your amount of UAH: ' + Fore.RESET))
                if b == "a":
                    b = a
                elif b != "a":
                    b = float(b)
                ...
                c = int(input(Fore.LIGHTBLUE_EX + "If you need write to variable USD, write '1', to write EUR, write '2': " + Fore.RESET))
                if c == 1:
                    a = b / USD_in_UAH
                elif c == 2:
                    a = b / EUR_in_UAH
            elif end == 2:
                b = str(input(Fore.MAGENTA + 'Write your amount of USD: ' + Fore.RESET))
                if b == "a":
                    b = a
                elif b != "a":
                    b = float(b)
                ...
                c = int(input(Fore.LIGHTBLUE_EX + "If you need write to variable UAH, write '1', to write EUR, write '2':" + Fore.RESET))
                if c == 1:
                    a = b * USD_in_UAH
                elif c == 2:
                    a = b * USD_in_UAH / EUR_in_UAH
            elif end == 3:
                b = str(input(Fore.MAGENTA + 'Write your amount of EUR: ' + Fore.RESET))
                if b == "a":
                    b = a
                elif b != "a":
                    b = float(b)
                ...
                c = int(input(Fore.LIGHTGREEN_EX + "If you need write to variable USD, write '1', to write UAH, write '2': " + Fore.RESET))
                if c == 1:
        ...
        if resp.status_code == 200:
            ...
            res = str(soup_list[39]).split('<td data-label="Official rate">')
        ...
        if resp.status_code == 200:
            soup = BeautifulSoup(resp.text, features="html.parser")
            soup_list = soup.find_all("td")
            res = str(soup_list[44]).split('<td data-label="Official rate">')
            res = str(res[1]).split('</td>')
        ...
        end = int(input(Fore.LIGHTGREEN_EX +"Choose convertor, if you neet from UAH to USD and EUR write 1, from USD to UAH and EUR write 2, from EUR to USD and UAH write 3: "+ Fore.RESET))
        if end == 0:
            sys.exit()
        counter(end)
